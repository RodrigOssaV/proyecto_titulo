...
router.get('/results_all_drivers_limit', [authJwt.verifyToken], financesControler.results_all_drivers_limit);
...
router.get('/results_drivers_by_suppliers_limit', [authJwt.verifyToken], financesControler.results_all_drivers_limit);
